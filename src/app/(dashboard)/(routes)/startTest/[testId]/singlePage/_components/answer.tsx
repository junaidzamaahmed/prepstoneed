...
export default function Answer({
  ...
  return (
    <div className="ps-2 flex items-center space-x-2 rounded-lg border border-gray-200 hover:bg-gray-50 transition-colors">
      <StrikethroughIcon
      ...
      />
      <RadioGroupItem value={answer.id} id={answer.id} checked={isChecked} />
      <Label
        htmlFor={answer.id}
